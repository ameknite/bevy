...
/// behaviour such as 3D camera control. Please see [`MouseMotion`] instead.
///
...
pub enum ApplicationLifetime {
    ...
    ///
    /// On Android, applications have one frame to react to this event before being paused in the
    /// background.
    Suspended,
