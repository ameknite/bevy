...
/// this specific PBR deferred lighting pass. Will be automatically added to entities with the
/// [`DeferredPrepass`] component that don't already have a [`PbrDeferredLightingDepthId`].
