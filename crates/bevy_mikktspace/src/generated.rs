...
// normal: vT, vB and vN. pixel shader (fast transform out)
...
// spaces will differ eventhough the vertex level tangent spaces match. This can be solved either by
// triangulating before sampling/exporting or by using the order-independent choice of diagonal for
// splitting quads suggested earlier. However, this must be used both by the sampler and your
// tools/rendering pipeline. internal structure
