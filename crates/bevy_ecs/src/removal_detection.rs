...
/// For the main world, [`World::clear_trackers`](World::clear_trackers) is run after the main
/// schedule is run and after `SubApp`'s have run.
///
/// # Examples
///
/// Basic usage:
...
///     removed
///         .read()
///         .for_each(|removed_entity| println!("{:?}", removed_entity));
/// }
