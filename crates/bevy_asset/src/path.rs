...
/// [`AssetPath::parse`] or [`AssetPath::from<'static str>`].
...
// NOTE: We manually implement "reflect value" because deriving Reflect on `AssetPath` breaks
// dynamic linking See https://github.com/bevyengine/bevy/issues/9747
