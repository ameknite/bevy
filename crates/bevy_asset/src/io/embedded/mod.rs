...
impl EmbeddedAssetRegistry {
    ...
    /// will be returned for the asset. This can be _either_ a `&'static [u8]` or a [`Vec<u8>`].
    #[allow(unused)]
    ...
    // NOTE: unused_mut because embedded_watcher feature is the only mutable consumer of `let mut
    // source`
    #[allow(unused_mut)]
