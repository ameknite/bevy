        ...
        .add_systems(
            ...
            (
                increment_input_counter
                    ...
                    // `.or_else()` is a run condition combinator that only evaluates the second
                    ...
                    .run_if(resource_exists::<Unused>.or_else(
                        ...
                        // Note that this second run condition will be evaluated even if the first
                        // returns `false`.
                        has_user_input,
                    )),
                print_input_counter
                    // `.and_then()` is a run condition combinator that only evaluates the second
